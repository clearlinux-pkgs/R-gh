...
Version  : 1.3.0
Release  : 33
URL      : https://cran.r-project.org/src/contrib/gh_1.3.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gh_1.3.0.tar.gz
Summary  : 'GitHub' 'API'
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619792336
