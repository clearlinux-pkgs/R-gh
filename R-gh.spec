...
Version  : 1.2.1
Release  : 27
URL      : https://cran.r-project.org/src/contrib/gh_1.2.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gh_1.2.1.tar.gz
Summary  : 'GitHub' 'API'
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617378969
