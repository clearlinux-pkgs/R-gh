...
Source0  : https://cran.r-project.org/src/contrib/gh_1.1.0.tar.gz
Summary  : 'GitHub' 'API'
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589759257
...
/usr/lib64/R/library/gh/tests/testthat/test-na-null.R
/usr/lib64/R/library/gh/tests/testthat/test-token.R
